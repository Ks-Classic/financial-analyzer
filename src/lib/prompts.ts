...
・確認できない事項は「要因は担当者に確認が必要」と明記してください
...
【数値記載ルール - 正確性の担保】
・画像から読み取った数値は、桁区切り（カンマ）を含めて正確に転記してください
・変化率を記載する場合は、計算過程が正しいことを必ず検証してください
・計算例: 前月比 = (当月値 - 前月値) / 前月値 × 100
・複数の数値を比較する場合は、同じ単位で統一してください（千円 or 百万円）
...
□ 推測・推量表現（〜と考えられます、〜の影響と思われます）が含まれていないか
